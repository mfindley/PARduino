/* Example code pulled from http://dlnmh9ip6v2uc.cloudfront.net/datasheets/BreakoutBoards/DS3234_Example_Code.pde
   Used to read configuration settings on a Sparkfun DeadOn Real Time Clock breakout board using the DS3234.
   This sketch was used to configure the clock for eventual use in a data logging application. 

/*
 ...
 This sketch has a particularly verbose stream of data going to the PC in order to confirm logic and do general debugging, but makes use of the software serial library to 
 open up a separate serial string and send only the PAR value and date/time to the data logger.
